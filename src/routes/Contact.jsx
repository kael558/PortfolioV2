...
const Contact = () => {
	...
	return (
		<div className=" bg-gray-900 text-gray-100 px-4 sm:px-6 lg:px-8">
			<Helmet>
				<title>Contact — Rahel Gunaratne</title>
				<meta name="description" content="Get in touch with Rahel Gunaratne. Available for collaborations, contracts, and consultations. Book a meeting or send a message." />
				<meta property="og:title" content="Contact — Rahel Gunaratne" />
				<meta property="og:description" content="Get in touch with Rahel Gunaratne. Available for collaborations, contracts, and consultations." />
				<meta property="og:url" content="https://rahelgunaratne.com/contact" />
				<meta property="og:type" content="website" />
				<link rel="canonical" href="https://rahelgunaratne.com/contact" />
			</Helmet>
