...
const PastProjectsPage = () => {
	...
	return (
		<div className="min-h-screen bg-gray-900 text-gray-100  pb-12 px-4 sm:px-6 lg:px-8">
			<Helmet>
				<title>Past Work — Rahel Gunaratne</title>
				<meta name="description" content="Rahel Gunaratne's completed projects spanning AI, data science, web development, hackathons, and contracts." />
				<meta property="og:title" content="Past Work — Rahel Gunaratne" />
				<meta property="og:description" content="Completed projects spanning AI, data science, web development, hackathons, and contracts." />
				<meta property="og:url" content="https://rahelgunaratne.com/past-projects" />
				<meta property="og:type" content="website" />
				<link rel="canonical" href="https://rahelgunaratne.com/past-projects" />
			</Helmet>
